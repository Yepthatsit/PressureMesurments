...
class UniversalPlotter:
    """_summary_
    class made to create n live plots out of a csv file which will always be in n columns
    """
    figure = plt.figure()
    filename:str = ''
    plots_to_make:list = []
    ...
    lines:list = []
    sep = ""
    def __init__(self,file:str,plots:list,coll_num:int = 2,separator:str = ' ',markersize = 3) -> None:
        """_summary_
